 <div class="tab-pane main-tabpane" id="cache" role="tabpanel" aria-labelledby="cache-tab">
    <div class="mpg-container d-flex align-items-start cache-page">
        <div class='main-inner-content'>
            <div class="card w-100 p-0 m-0 mb-4 mpg-card">
                ...
                <div class="card-body">
                    <div class="sub-section">
                        <div class="d-flex justify-cotent-center rows">
                            <div class="box">
                                <div class="card disk">
                                    <div class="card-img-top">
                                        <div class="image">
                                            <svg enable-background="new 0 0 46 58" height="120" viewBox="0 0 46 58" width="120" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="card-body">
                                        <h3><?php _e('Disk', 'mpg'); ?></h3>
                                        <div class="card-text">
                                            <?php _e('Save cached pages on disk as static files.', 'mpg'); ?>
                                        </div>
                                        <hr />
                                        <h4><?php _e('Statistic', 'mpg'); ?></h4>
                                        <div class="card-text">
                                            <div class="text-group">
                                                <span class="label"><?php _e('Pages in cache:', 'mpg'); ?></span>
                                                <span class="pages-in-cache"><?php _e('Loading', 'mpg'); ?></span>
                                            </div>
                                            <div class="text-group">
                                                <span class="label"><?php _e('Cache size:', 'mpg'); ?></span>
                                                <span class="cache-size"><?php _e('Loading', 'mpg'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer" data-cache-type="disk">
                                        <button class="btn btn-success enable-cache"><?php _e('Enable', 'mpg'); ?></button>
                            ...
                            <div class="box">
                                <div class="card database">
                                    <div class="card-img-top">
                                        <div class="image">
                                            <svg width="140" height="160" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 96 96" xml:space="preserve">
                                                <g>
                                    ...
                                    <div class="card-body">
                                        <h3><?php _e('Database', 'mpg'); ?></h3>
                                        <div class="card-text"><?php _e('Save content of pages as record in database', 'mpg') ?></div>
                                        <hr />
                                        <h4><?php _e('Statistic', 'mpg'); ?></h4>
                                        <div class="card-text">
                                    ...
                                    <div class="card-footer" data-cache-type="database">
                                        <button class="btn btn-success enable-cache"><?php _e('Enable', 'mpg'); ?></button>
                                        <button disabled="disabled" class="btn btn-light flush-cache"><?php _e('Flush', 'mpg'); ?></button>
                                    </div>
                                </div>
            ...
            <div class="alert alert-warning" role="alert">
                <div class="icon">
                    <img src=<?php echo esc_url( MPG_BASE_IMG_PATH . '/info-icon.png' ); ?> alt="" />
                </div>
                <div class="info">
                    <?php _e('Important: Cache works with non-logged in users only. If you are logged as WP admin and visit MPG generated page, it will not be cached. Use private/incognito window to test.', 'mpg'); ?>
                </div>
            </div>
        </div>
